...
function Home() {
  ...
  const { products, fruits, vegetables, popular } = useSelector(
    (state) => state.product
  );
  ...
  const fetchProduct = () => {
    let products = [
      ...
      },
      {
        ...
        was: 12,
        weight: "100 gm",
        pic: "https://cdn.pixabay.com/photo/2017/01/07/14/56/ginger-1960613_1280.jpg",
        popular: 1,
        type: "vegetables",
      },
      {
  ...
  return (
    <div>
      <Banner />
      <Cards />
      {/* <Popular title="Popular Items" items={popular} /> */}
